...
def gen_imgs_o3d():
    ...
    labels_path = 'labels_'+ "1" + '.csv'
    csv_path = os.path.join(LABELS_DIR,labels_path)

    with open(csv_path,"a") as file:
        for i in range(103008,200000):
...
def test_pose_model():
    ...
    model = tf.keras.models.load_model("/home/glsrujan/Documents/personal/raise_robotics/pose_est/cnn_models/3d_pose_97")
    ...
    for i in range(50):
        ...
        for point_tru in bbox_vert_true:
            ...
            # cv2.putText(disp_img, "{}".format(num), point_tru, font, 1, (255,50,50), 1, cv2.LINE_AA)
            num+=1
